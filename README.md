...
This project demonstrates a complete DevOps workflow using the **GitHub MCP (Model Context Protocol) Server** integration with VS Code Copilot. The scenario showcases how AI can assist in the entire software development lifecycle from issue detection to deployment through a human-in-the-loop approach where AI provides assistance but requires step-by-step guidance.

> **📍 Demo Series Navigation**  
> 🤖 **Want full AI-assisted coding?** Skip to the [GitHub Coding Agent Demo](https://github.com/david-pizzi-cg/github-coding-agent-demo) for autonomous AI development workflows
...
5. **Follow**: Use the prompts from each phase in sequence (Phases 1-6)
6. **Cleanup**: Run post-demo cleanup when finished (Phase 7)
